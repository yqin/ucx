...
typedef ucs_status_t (*uct_md_mkey_pack_address_func_t)(
        uct_md_h md, uct_mem_h memh, const uct_md_mkey_pack_params_t *params,
        void *buffer);

typedef ucs_status_t (*uct_md_mkey_pack_flags_func_t)(
        uct_md_h md, uct_mem_h memh, const uct_md_mkey_pack_params_t *params,
        void *buffer);
...
struct uct_md_ops {
    ...
    uct_md_mkey_pack_address_func_t      mkey_pack_address;
    uct_md_mkey_pack_flags_func_t        mkey_pack_flags;

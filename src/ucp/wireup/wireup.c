...
static int ucp_ep_params_shared_mkey(const ucp_ep_params_t *params)
{
    return (params->field_mask & UCP_EP_PARAM_FIELD_FLAGS) &&
           (params->flags & UCP_EP_PARAMS_FLAGS_SHARED_MKEY);
}
                           ...
                           const ucp_ep_params_t *params)
{
    ...
    if (ucp_ep_params_shared_mkey(params)) {
        flags |= UCP_EP_INIT_FLAG_SHARED_MKEY;
    }
